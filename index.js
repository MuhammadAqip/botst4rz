...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Scan kode qr mu dengan app!`);
});
...
axios.get(`https://mhankbarbar.herokuapp.com/api/wiki?q=${teks}&lang=id&apiKey=IsDssiTLL9hE7ofCV1Ot`).then((res) => {
